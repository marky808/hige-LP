...
const EBook = () => {
    ...
    return (
        <div className="bg-[#f7fafc] min-h-screen p-5 flex justify-center items-start px-4">
            <div className="max-w-3xl w-[800px] mx-auto bg-white rounded-lg shadow-lg p-8 pt-16">
                ...
                <div className="bg-[#f8f9fa] p-6 rounded-lg">
                    ...
                    <ul className="space-y-8 text-left pl-6">
                        <li
                            className="text-lg text-[#2c5282] hover:text-blue-600 transition-colors cursor-pointer"
